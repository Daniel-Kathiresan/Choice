...
class DateAdapter: ListAdapter<DateItem, DateAdapter.ViewHolder>(diffUtil) {

    inner class ViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {

        //Set content on recycleviewer
        fun bind(dateItem: DateItem) {
            view.findViewById<TextView>(R.id.user_name).text = dateItem.name
            view.findViewById<TextView>(R.id.user_bio).text = dateItem.date + " " + dateItem.time
