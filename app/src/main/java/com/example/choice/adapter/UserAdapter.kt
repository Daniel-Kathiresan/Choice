package com.example.choice.adapter
...
import com.example.choice.FriendListFragment
...
class UserAdapter(private val context: Context, private val userList:ArrayList<User>) :
    ...
    class ViewHolder(view:View):RecyclerView.ViewHolder(view){
        ...
        val txtTemp: TextView = view.findViewById(R.id.textView_bio)
        val imgUser: CircleImageView = view.findViewById(R.id.userImage)
        val layoutUser: LinearLayout = view.findViewById(R.id.cardView_item_user)
    }
}